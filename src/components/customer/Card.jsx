...
const Card = (props) => {
    ...
    return (
        <div className={`card-container bg-${props.type == "test" ? "[#0d5d73] bg-opacity-15" : "[#0d5d73]"} hover:bg-${props.type == "test" ? "[#0d5d73] hover:bg-opacity-20" : "[#157792]"}`} onClick={props.onClick}>
