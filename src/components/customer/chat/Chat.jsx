...
const Chat = (props) => {
    ...
    return(
        <>
            ...
            <div className='border border-[var(--light-border-color)] relative rounded-lg bg-white flex flex-col items-center justify-start h-auto w-full sm:w-11/12 md:w-3/4 xl:w-3/5' id='new-order' onClick={(e) => e.stopPropagation()}>
