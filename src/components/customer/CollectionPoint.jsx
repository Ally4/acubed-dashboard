...
const CollectionPoint = () => {
    ...
    return(
        <section id='orders'>
            <div className='w-full md:w-11/12 lg:w-11/12 mt-4 mb-4'>
            ...
            <div className='w-11/12 md:w-2/3 xl:w-3/5 max-w-[800px] mt-4 mb-4 grid grid-cols-2 gap-2 md:gap-6 xl:gap-12 h-16 border-2 bg-white border-[var(--light-border-color)] rounded-full p-1'>
                <div className={`rounded-full flex items-center justify-center w-full cursor-pointer h-full ${selected === 'Facility' ? 'bg-[#0d5d73] hover:bg-[#09495a]' : ''}`} onClick={() => setSelected('Facility')}>
                    <label className={`mt-2 cursor-pointer text-sm md:text-base xl:text-lg font-semibold ${selected === 'Facility' ? 'text-white' : 'text-[#0d5d73]'}`}>Facility</label>
                </div>
                ...
                <div className={`rounded-full flex items-center justify-center w-full cursor-pointer h-full ${selected === 'Home' ? 'bg-[#0d5d73] hover:bg-[#09495a]' : ''}`} onClick={() => setSelected('Home')}>
                    <label className={`mt-2 cursor-pointer text-sm md:text-base xl:text-lg font-semibold ${selected === 'Home' ? 'text-white' : 'text-[#0d5d73]'}`}>Home or Other</label>
                </div>
            </div>
